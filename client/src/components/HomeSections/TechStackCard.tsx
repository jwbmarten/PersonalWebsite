...
const techItems: TechItem[] = [
  ...
  { name: "C", icon: "/icons/tech_icons/C.svg", color: "#a8b9cc" },
];
    ...
    <div>
      <div className="p-6 rounded-xl bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-md shadow-lg ring-1 ring-white/20 border border-white/10">
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <h3 className="text-[#5bb25b] font-unica text-xl pt-1">TECH I USE</h3>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
          {techItems.map((tech) => (
            <div
              key={tech.name}
              className="flex flex-col lg:flex-row lg:items-center lg:gap-2 items-center justify-center px-4 py-3 rounded-xl bg-black/9 border border-black/10 hover:border-white/30 transition"
            >
