...
import PulseCheckImg from '../assets/pulseCheck_new.png'
...
export const projects: Project[] = [
    ...
    id: 'pulse-check',
    title: 'PulseCheck',
    subtitle: 'Healthcare Analysis WebApp',
    description:
    ...
    year: 2024,
    links: [{ label: 'GitHub ↗', href: 'https://github.com/jwbmarten/Pulse-Check' }],
  },
  {
    id: 'garmin-watchface',
    title: 'jwBlock',
    subtitle: 'Embedded Garmin Watch Face',
    description:
    ...
    year: 2024,
    links: [{ label: 'GitHub ↗', href: 'https://github.com/jwbmarten/jwblock' }],
  },
  {
    id: 'pixel-solitaire',
    title: 'Pixel Solitaire',
    subtitle: 'Java Computer Game',
    description:
    ...
    year: 2023,
    links: [
      { label: 'GitHub ↗', href: 'https://github.com/jwbmarten/PixelSolitaireREDUX' },
    ],
  },
];
